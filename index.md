...
調査実習で使える関数を作ってみました。やる気があればマルチレベルモデルなどもつくります。
...
- 回帰分析（以下をサポート）
  - 線形回帰：`lm`
  - 2項ロジスティック回帰：`glm`
  - 多項ロジスティック回帰：[`nnet::multinom`](https://rdrr.io/pkg/nnet/man/multinom.html)
...
![](reference/figures/jisshu_cross.png)

- 線形回帰

![](reference/figures/jisshu_reg_lm.png)

- 2項ロジスティック回帰

![](reference/figures/jisshu_reg_glm.png)

- 多項ロジスティック回帰

![](reference/figures/jisshu_reg_multinom.png)
